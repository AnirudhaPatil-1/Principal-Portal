...
const PrincipalPortal = () => {
  return (
    <div className=" flex  items-center  bg-stone-300 p-20 ">
      <div className="flex flex-col justify-between items-start mr-12 gap-8 ">
        <img className="w-60 h-60" src={Logo} alt="logo" />
        <div>
          <h1 className="w-96 h-24 text-center text-neutral-800 text-6xl font-semibold capitalize">PrincipalPortal</h1>
        </div>
        <div className=" w-96 h-20 flex justify-start items-center bg-white rounded-full shadow border border-stone-300">
          ...
          <input className="text-zinc-800" placeholder="What are you looking for" />
        </div>
      </div>
